        ...
        <div className="absolute right-0 bg-white rounded-md overflow-hidden shadow-lg z-10">
          <div className="">
            ...
            <div
              ...
              className="py-4 group hover:bg-blue-500 transition-all ease-in-out" >
              <button className="text-left w-full px-4 text-white group-hover:text-white transition-all ease-in-out">
                Edit Profile
              </button>
            </div>
            <hr />
